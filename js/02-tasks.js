...
//Додаткові
/**
 * 1 - Створити змінну, яка містить рядок з вашим ім'ям та прізвищем.
 * Використовуючи метод .length вивести в консоль кількість символів у рядку.
 * 2 - Створити змінну, яка містить рядок з вашим ім'ям. Використовуючи метод 
 * .toUpperCase() перетворити рядок у верхній регістр та вивести результат в 
 * консоль.
 * 3 - Створити змінну, яка містить рядок з вашим ім'ям. Використовуючи метод 
 * charAt(), вивести перший символ вашого імені в консоль.
 * 4 - Створити змінну, яка містить рядок з вашим ім'ям та прізвищем.
 * Використовуючи метод .indexOf()знайти і вивести в консоль позицію, на якій
 * знаходиться пробіл між ім'ям та прізвищем.
 * 5 - Створити змінну, яка містить рядок з вашим ім'ям. Використовуючи метод 
 * replace(), замінити першу літеру вашого імені на символ "@" та вивести
 * результат в консоль.
 */
